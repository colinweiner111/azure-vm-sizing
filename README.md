...
**👉 [Azure VM Sizing Demystified](https://colinweiner111.github.io/azure-vm-sizing/azure-vm-sizing-demystified.html)**
...
- **Documentation Navigation** – How Microsoft's docs map to the family → series → size hierarchy
